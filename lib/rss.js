...
function buildRssFeed (headElements, historyArray) {
	...
	const localTimeFormat = "ddd, mmmm d, yyyy h:MM TT Z"; //5/16/24 by DW
	function add (s) {
	...
	add ("<rss version=\"2.0\" xmlns:source=\"http://source.scripting.com/\"" + contentNamespaceDecl + facebookNamespaceDecl + ">"); indentlevel++ //7/2/23 by DW
	...
	//add header elements
		...
		add ("<source:localTime>" + starttime.toLocaleString () + "</source:localTime>"); //5/16/24 by DW
